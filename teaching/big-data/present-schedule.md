...
从第4周，即3月17日课上开始按以下顺序进行。

| 顺序 | 演讲人 | 题目                                                 | 幻灯片                  |
|------|--------|------------------------------------------------------|-------------------------|
| 1    | 郑超   | 大数据的概念、特征及其应用                           | [PPT](zhengchao.pptx)   |
| 2    | 张霞文 | 数据挖掘与医学数据资源开发利用                       | [PPT](zhangxiawen.pptx) |
| 3    | 张瑞芝 | 大数据技术                                           | [PPT](zhangruizhi.ppt)  |
| 4    | 张大卫 | 云计算                                               | [PPT](zhangdawei.pptx)  |
| 5    | 张晨   | HadoopMapReduce 短作业执行性能优化                   | [PPT](zhangchen.pptx)   |
| 6    | 吴庆洲 | 基于共同用户的跨网络分析: 社交媒体大数据中的多源问题 | [PPT](wuqingzhou.pptx)  |
| 7    | 王子尧 | 数据挖掘的研究进展及在临床医学中的应用               | [PPT](wangziyao.pptx)   |
...
1.  陈功, et al., 数据挖掘与医学数据资源开发利用. 北京生物医学工程, 2010.
    v.29(03): p. 323-328.

2.  秦文哲, 陈进, and 董力, 大数据背景下医学数据挖掘的研究进展及应用.
...
2.  姚刚, 张晓祥, and 汪火明, 基于WEB的医学数据挖掘集成. 生物医学工程学杂志,

3.  v.31(03): p. 563-566.

4.  周攀 and 王开正, 数据挖掘的研究进展及在临床医学中的应用. 国际检验医学杂志,

5.  v.33(10): p. 1230-1232.
...
1.  Bekkerman, R., M. Bilenko, and J. Langford, Scaling up machine learning:
